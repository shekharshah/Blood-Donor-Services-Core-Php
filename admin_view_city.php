...
include("admin_function.php");
 ...
 $sql="SELECT city.CITY_NAME, state.STATE_NAME, city.CITY_ID FROM state Inner Join city ON city.STATE_ID = state.STATE_ID  ORDER BY city.CITY_ID";
...
$sql="Select city.CITY_NAME, state.STATE_NAME,country.COUNTRY_NAME, city.CITY_ID
From country,state Inner Join
city On city.STATE_ID = state.STATE_ID  ORDER BY city.CITY_ID DESC  $limit";

 $textline1="<br>Total City : $rows";
	...
	<div class="row">
		...
		<div class="col-sm-9" >
			<h3><i class="fa fa-bank"></i> View City Details </h3><hr>
				...
				<div class="col-md-12">
          <a href="admin_city.php" class="btn btn-primary btn-sm"><i class="fa fa-arrow-left fa-lg" aria-hidden="true"></i> Back to Previous Page</a>
