...
$sql="SELECT * FROM country  $z ";
$textline1="<br>Total Country : $rows";
...
<div class="container">
	<div class="row">
		...
		<div class="col-sm-9" >
			<h3><i class="fa fa-bank"></i> View Country Details </h3><hr>

				<div class="col-md-12">

          <a href="admin_country.php" class="btn btn-primary btn-sm"><i class="fa fa-arrow-left fa-lg" aria-hidden="true"></i> Back to Previous Page</a>
